...
# Methods
We applied an user-centered design to develop a minimal viable product that can help Swiss OTAs to leverage social media and seach data to optimize conversion accross traveler's digital jounery, to achieve the project goal, a travel database is built with the following data engeneer techniques: 
